...
def test_get_user_by_email_success(client, mocker):
    ...
    mocker.patch('simple_rest_api.app.models.user.User.find_user_with_email', return_value=mock_user)
...
def test_get_user_success(client, mocker):
    ...
    mocker.patch('simple_rest_api.app.models.user.User.find_all_user', return_value=mock_user)
...
def test_get_user_by_email_not_found(client, mocker):
    mocker.patch('simple_rest_api.app.models.user.User.find_user_with_email', return_value=None)
...
def test_create_user_success(client, mocker):
    mock_save = mocker.patch('simple_rest_api.app.models.user.User.save', return_value=None)
...
def test_create_user_invalid_request_body(client, mocker):
    mocker.patch('simple_rest_api.app.models.user.User.save', side_effect=CustomException("Request body is invalid!"))
...
def test_create_user_invalid_email(client, mocker):
    mocker.patch('simple_rest_api.app.models.user.User.save', side_effect=CustomException("Enter a valid email!"))
...
def test_create_user_invalid_key(client, mocker):
    mocker.patch('simple_rest_api.app.models.user.User.save')
